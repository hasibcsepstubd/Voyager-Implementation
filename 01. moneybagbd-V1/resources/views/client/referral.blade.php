                ...
                {{--<div class="col-md-12 col-sm-12 col-xs-12">--}}
                    ...
                    <div class="col-sm-9 col-md-10 col-xs-12">
                        <p class="alt-font text-gray font-weight-600">Your Referral Code: <b
                            ...
                            Total: $ @if(!isset(Auth::user()->current_referral_amount)) {{$total}} @else {{Auth::user()->current_referral_amount}} @endif<b></b></p>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{url('/client/referral-withdraw')}}" method="POST" id="form_modal"
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="withdraw" class="form-control" value="" id="withdraw" placeholder="Amount"
                                           autofocus required max="@if(!isset(Auth::user()->current_referral_amount)) {{$total}} @else {{Auth::user()->current_referral_amount}} @endif" min="1">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="account_no" class="form-control" value="" id="account_no" placeholder="Email or Mobile"
                                           autofocus required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="total" id="total" value="@if(!isset(Auth::user()->current_referral_amount)) {{$total}} @else {{Auth::user()->current_referral_amount}} @endif">
                    </div>
                </form>
            </div>
        </div>
