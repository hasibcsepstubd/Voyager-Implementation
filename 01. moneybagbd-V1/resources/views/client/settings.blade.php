...
@section('content')
    ...
    <div>
        <h5 class="animated fadeInDown page-header text-uppercase alt-font text-gray font-weight-600 padding-30px-left padding-10px-top">Profile
            Settings</h5>
    </div>
    ...
    <div class="wow slideInUp padding-30px-top" style="visibility: hidden; animation-name: slideInUp;">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <form action="{{url('/client/user-info-update')}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="mobile_1" value="{{$profile_info->mobile_1}}" maxlength="11" minlength="11"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input name="mobile_2" value="{{$profile_info->mobile_2}}" maxlength="11" minlength="11"
                                       type="number">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select name="gender" required>
                                    ...
                                    <option value="Female" @if($profile_info->gender=='Female') selected @endif>Female
                                    </option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <input name="submit" value="Save Change" class="btn btn-small border-radius-4 btn-deep-pink"
                                   type="submit">
                        </div>
                    </div>
                </div>
