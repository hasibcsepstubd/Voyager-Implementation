                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    @endforeach
                                    <th class="actions" style="text-align: center">{{ __('voyager.generic.actions') }}  </th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($dataTypeContent as $data)
                                    <tr class="{{ ($data->status=='Processing') ? 'order-processing' : '' }}">
                                        @can('delete',app($dataType->model_name))
                                            <td>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions" >
                                            @can('delete', $data)
                                                <a href="javascript:;" title="{{ __('voyager.generic.delete') }}" class="btn btn-sm btn-danger pull-right delete" data-id="{{ $data->{$data->getKeyName()} }}" id="delete-{{ $data->{$data->getKeyName()} }}">
                                                    <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm hidden-md hidden-lg">{{ __('voyager.generic.delete') }}</span>
                                                </a>
                                            @endcan
                                            @can('edit', $data)
                                            ...
                                            @can('read', $data)
                                                <a href="{{ route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()}) }}" title="{{ __('voyager.generic.view') }}" class="btn btn-sm btn-warning pull-right">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm hidden-md hidden-lg">{{ __('voyager.generic.view') }}</span>
                                                </a>
                                            @endcan
                                        </td>
                                    </tr>
