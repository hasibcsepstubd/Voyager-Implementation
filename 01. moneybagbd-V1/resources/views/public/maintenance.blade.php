...
<!-- Mirrored from www.themezaa.com/html/pofo/maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Mar 2018 07:53:37 GMT -->
<head>
    <!-- title -->
...
<section class="no-padding cover-background" style="background-image:url('images/maintenance-bg.jpg');">
    <div class="opacity-full bg-black"></div>
    <div class="container position-relative full-screen">
        <div class="slider-typography text-center">
            <div class="slider-text-middle-main xs-padding-15px-lr">
                <div class="slider-text-middle">
                    <img src="images/logo-white.png" data-at2x="images/logo-white@2x.png" class="margin-eight-bottom"
                         alt=""/>
                    ...
                    <div class="social-icon-style-10 margin-30px-top">
                        <ul class="medium-icon">
                            ...
                            <li><a class="twitter text-white" href="http://www.twitter.com/" target="_blank"><i
                                            class="fa fa-twitter"></i><span></span></a></li>
                            <li><a class="google text-white" href="http://www.google.com/" target="_blank"><i
                                            class="fa fa-google-plus"></i><span></span></a></li>
                            <li><a class="linkedin text-white" href="http://www.linkedin.com/" target="_blank"><i
