                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form class="form-horizontal" method="POST"
                                            ...
                                            {{ csrf_field() }}
                                            <input name="buy_status" value="1" type="hidden"></input>
                                                    ...
                                                    <select class="form-control" id="send" name="send">
                                                        @if(isset($sends))
                                                            @foreach($sends as $send)
                                                                <option data-sell="{{$send->sell}}"
                                                                        data-buy="{{$send->buy}}"
                                                                        data-id="{{$send->id}}"
                                                                        value="{{$send->curency_name}}">{{$send->curency_name}}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    {{--<p class="form-control" id="recevied"></p>--}}
                                                    <input class="form-control" step="any" name="send_amount"
                                                           placeholder="Amount" min="{{$home_info->min_order}}" onchange="validateNum(this);"
                                                           type="number">
