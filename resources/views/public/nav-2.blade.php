        ...
        <div class="col-md-12 col-sm-12 col-xs-12 no-padding-lr">
            <div id="navbar-menu" class="collapse navbar-collapse no-padding">
                <ul class="nav navbar-nav navbar-left-sidebar font-weight-600">
                    <li class="dropdown">
                        <a class="nav-link js-scroll-trigger" href="{{url('/public/home')}}#home">Home<i
                                    class="fa fa-angle-right pull-right"></i></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link js-scroll-trigger" href="{{url('/public/home')}}#buy_and_sell">Buy, Sell &
                            Exchange<i
                    ...
                    <li class="dropdown">
                        <a href="{{url('/public/home')}}#notice">Notice<i class="fa fa-angle-right"></i></a>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link js-scroll-trigger" href="{{url('/public/home')}}#about_us">About us<i
                                    class="fa fa-angle-right"></i></a>
                    </li>

                    <li class="dropdown">
                        <a class="nav-link js-scroll-trigger" href="{{url('/public/home')}}#testimonial">Testimonial<i
                                    class="fa fa-angle-right"></i></a>
                    </li>
